...
declare -A deps_arch=(
    ...
    tree-sitter-cli: A command-line tool to work with tree-sitter parsers,
    libtexprintf: A small library that formats TeX style strings for LaTeX related tools,
    "
    ["installer"]="
    unzip, 
    git, 
