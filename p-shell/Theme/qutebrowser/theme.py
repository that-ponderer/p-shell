...
def apply(c,samecolorrows=False):
    ...
    c.colors.completion.scrollbar.fg = colors["8"]
    # }}}
    ...
    c.colors.messages.info.bg = colors["8"]
    ## Background color of a warning message.
    c.colors.messages.warning.bg = colors["8"]
    ...
    c.colors.prompts.border = "1px solid " + colors["8"]
    ...
    c.colors.tabs.even.fg = colors["8"]
    ## Foreground color of unselected odd tabs.
    c.colors.tabs.odd.fg = colors["8"]
    ...
    c.colors.contextmenu.disabled.fg = colors["8"]

    c.colors.contextmenu.selected.bg = colors["8"]
